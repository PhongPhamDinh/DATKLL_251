...
REM
REM Generated by Vivado on Sat Jan 17 08:58:50 +0700 2026
...
echo "xvlog --incr --relax -prj tb_cpu_single_vlog.prj"
call xvlog  --incr --relax -prj tb_cpu_single_vlog.prj -log xvlog.log
